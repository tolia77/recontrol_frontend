 ...
 * WebSocket — so the panel is hosted with `ws={null}` and `runEnabled={false}`,
 * which disables [▶ Run] and surfaces a hint pointing the operator at a device
 * session. The panel's run-mode / policy-preview machinery stays inert.
 */
function Scenarios() {
  return (
