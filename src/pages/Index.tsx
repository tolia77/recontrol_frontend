        ...
        <div className="container mx-auto px-6 py-20 flex items-center justify-center">
          <div className="max-w-3xl text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <Link to="/signup">
                <Button variant="secondary" size="lg">{t('hero.signup')}</Button>
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 py-10 text-center text-white">
          ...
          <div className="mt-6 text-white/80 text-caption-small">
            <Trans
              ns="index"
              i18nKey="cta.help"
              components={{ helpLink: <Link to="/help" className="underline text-white" /> }}
            />
          </div>
        </div>
      </section>
...
function Step({ number, title, text }: StepProps) {
  return (
    <div className="p-5 rounded-xl border border-lightgray bg-white hover:shadow-sm transition-shadow">
