 ...
 * NEVER calls navigator.permissions.query — Firefox throws TypeError on
 * { name: 'clipboard-read' }. Capability detection is feature-presence only;
 * permission state is surfaced via the readText try/catch path in
 * useClipboardSync.
 */
