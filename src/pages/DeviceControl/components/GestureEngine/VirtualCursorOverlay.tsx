 ...
 *
 * Local virtual cursor dot for touch remote control (D-08).
 *
 ...
 * zero re-render latency per pointermove (D-08).
 *
 ...
 * philosophy.
 *
 * S7: `export default` component with a co-located named `Props` type.
 * No `md:`/`lg:`/`touch-screen:` utilities (S5 — no breakpoint desync risk).
 */
...
export interface Props {
  /**
   * Ref the caller (useVirtualCursor / Plan 04 wiring) uses to mutate the
